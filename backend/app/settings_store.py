...
FIELDS: list[Field] = [
    ...
    Field("correlation_guard_enabled", "bool", "Correlation guard",
          note="Scale down entries correlated + same-direction with the open book."),
    Field("correlation_threshold", "float", "Correlation threshold", 0.0, 1.0),
    Field("correlation_scale", "float", "Correlation size scale", 0.0, 1.0),
